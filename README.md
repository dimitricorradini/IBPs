...
If one wants to run this themselves, it is recommended that one has at least these programs installed and appended to the Mathematica path. The directories F1 through F9 compute various topologies related to the three-loop form factor in N=4 sYM. The directories 3LLad and 3LTC compute the three-loop ladder topology and 'tennis-court' topology respectively, relevant for the four-point amplitude at three-loops in N=4 sYM.
